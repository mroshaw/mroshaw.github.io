...
Just a reminder here, that if you following the [earlier steps](creating-a-project.md) to install the Subnautica community template packages, you won't have to mess around with references. Everything will be handled nicely for you by the templates.
